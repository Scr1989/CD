	...
	var n = function() {
		...
		this.move = function(t, r) {
			...
			if (!this.ul.is(":animated")) {
				...
				n.el.find("ul li:eq(" + t + ")").addClass("effect").siblings().removeClass("effect");
		...
		this.dots = function() {
			...
			t += "</ol>";
			this.el.addClass("has-dots").append(t).find(".dot").on({
				mouseover : function() {
					n.stop().move(e(this).index())
				},
				click : function(){
					n.stop().move(e(this).index())
				}
